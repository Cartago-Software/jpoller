...
public abstract class BidirectionalComparator implements Comparator
{
	...
	private void checkTypes(Object o1, Object o2)
	{
		if (!(o1 instanceof File && o2 instanceof File))
			throw new RuntimeException("Invalid object passed for comparison: expected (File, File), received (" + o1.getClass().getName() + ", " + o2.getClass().getName() + ")");
	}
	
	/**
	 * Expects the two objects to be of File class and returns the ordering indicator based on the direction specified at construction
	 */
